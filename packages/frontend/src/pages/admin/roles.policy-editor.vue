...
<template>
	<div class="_gaps_s">
		...
		<XFolder v-if="matchQuery([i18n.ts._role._options.vrtlAvailable, 'vrtlAvailable'])" v-model:policyMeta="policyMetaModel.vrtlAvailable" :isBaseRole="isBaseRole" :readonly="readonly">
